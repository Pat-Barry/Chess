...
/**
 *  
 * The Vector class's role is to represent the "shape" of a Piece's movement from it's position to a new position.
...
public class Vector {
	...
	/**
	 * Creates a vector from subtracting the x and y components of the first position from the second position.
	 ...
	 * @throws IllegalArgumentException  If provided a zero vector. Converted into IllegalMoveException upon being caught. 
	 */
	public boolean variationOf(int x, int y) throws IllegalArgumentException {
	 ...
	 */
	public boolean variationOfWithLimit(int x, int y, double limit) throws IllegalArgumentException {
